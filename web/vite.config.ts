...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Browser Canary e2e-create-mtrmotah-n2fb8m-test",
        short_name: "Browser Canary e2e-create-mtrmotah-n2fb8m-test",
        description: "Browser Canary e2e-create-mtrmotah-n2fb8m-test — free forever",
        start_url: "/",
        display: "standalone",
